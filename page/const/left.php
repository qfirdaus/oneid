				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					<div class="profile-box">
						<!-- <div class="profile-cover-pic"> -->
							<div class="profile-info text-center mb-15">
								...
								<h6 class=""><?php echo $user_info['data7']; ?></h6>
					...
					<li>
						<a class="active" href="javascript:void(0);" data-toggle="collapse" data-target="#app_dr">
							<div class="pull-left">
								<i class="ti-image mr-20"></i>
								<span class="right-nav-text">Aplikasi </span>
								<span class="label label-success" id='follo_data_list_count_text'></span>
							</div>
							<div class="pull-right"><i class="ti-angle-down"></i></div><div class="clearfix"></div>
						</a>											
					...
					<li>
						<a href="documentation.html"><div class="pull-left"><i class="ti-tablet mr-20"></i><span class="right-nav-text">Signed Devices</span></div><div class="clearfix"></div></a>
					</li>
				</ul>
			</div>
			<!-- /Left Sidebar Menu -->
