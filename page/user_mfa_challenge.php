...
<section class="mfa-content"><header class="mfa-top"><div><h2><?=$h('stepup.verify_identity')?></h2><p><?=$h('stepup.choose_available')?></p></div><span class="mfa-badge">USER MFA</span></header><div id="message"></div>
...
</section><a class="mfa-back" href="../">&#8592; <?=$h('stepup.back')?></a><footer class="mfa-foot"><span>OneID@UPNM</span><span>PTMK</span></footer></section></main>
<script>
