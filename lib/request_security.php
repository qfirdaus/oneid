...
function oneid_q_func_action_map(): array
{
    return [
        ...
        'user' => [
            ...
            'action_mydigitalid_password_recovery_request',
            'action_mydigitalid_password_recovery_verify',
        ...
        'admin' => [
            ...
            'admin_get_user_mfa_policy_workflow',
            'admin_request_user_mfa_policy_change',
            'admin_decide_user_mfa_policy_change',
            'admin_restore_user_mfa_emergency_bypass',
            ...
            'action_remove_app',
            'admin_get_archived_apps',
            'admin_restore_archived_app',
            'admin_purge_archived_app',
