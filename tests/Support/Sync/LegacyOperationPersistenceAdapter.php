...
/**
 * Test-only bridge from the D1 persistence contract to the legacy operation API.
 * It must not be required by production runtime files.
 */
final class LegacyOperationPersistenceAdapter implements SyncPersistenceInterface
{
