...
$report(str_contains($dashboard, 'oneid-user-session.js?v=20260808-2') && str_contains($dashboard, 'oneid-user-session.css?v=20260808-2'), 'user dashboard loads cache-busted controller assets');
...
$report(str_contains($security, 'oneid-user-session.js?v=20260808-2') && str_contains($security, 'OneIdUserSessionConfig'), 'authenticated Account Security page loads user controller');
