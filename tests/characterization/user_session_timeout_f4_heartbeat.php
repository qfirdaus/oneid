...
$report(str_contains($dashboard,'oneid-user-session.js?v=20260808-2')&&str_contains($security,'oneid-user-session.js?v=20260808-2'),'both authenticated user pages load the F4 cache-busted controller');
