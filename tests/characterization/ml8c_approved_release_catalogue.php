...
$report(
    $preview['release_count'] === 69
    && $preview['bm_item_count'] === 530
    && $preview['en_item_count'] === 530,
...
$report(
    $preview['approved_manifest_digest']
        === 'b211548762ee2ba9fc1f4b2003ef1cce4a0ada5e67aa9bffe40695ab500fa83c'
    && $preview['evidence_reference'] === 'ONEID-V2132-CHANGELOG-20260910-01',
