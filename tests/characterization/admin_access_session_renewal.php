...
$report(str_contains($client,'payload.effective_remaining_seconds !== undefined'),'Administrator controller schedules the effective base/grant deadline including zero remainder');
