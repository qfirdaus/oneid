...
$report(
    $manifest['translation_required_count'] === 18
    && $manifest['classification_counts']['INTERNAL_TECHNICAL_INVARIANT'] === 132,
...
$report(
    $byIdentity['release_ui:admin_dashboard']['entry_count'] === 38
