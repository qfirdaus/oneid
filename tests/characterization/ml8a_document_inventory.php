...
$report(
    $manifest['translation_required_count'] === 32
    && $manifest['classification_counts']['INTERNAL_TECHNICAL_INVARIANT'] === 186,
...
$report(
    $byIdentity['release_ui:admin_dashboard']['entry_count'] === 55
