...
$report(
    ...
    && $manifest['classification_counts']['INTERNAL_TECHNICAL_INVARIANT'] === 144,
...
$report(
    $byIdentity['release_ui:admin_dashboard']['entry_count'] === 39
