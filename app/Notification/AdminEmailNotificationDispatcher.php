...
final class AdminEmailNotificationDispatcher
{
    private const EVENTS = [
        ...
        'USER_PASSWORD_CHANGED','INITIAL_PASSWORD_SET','PASSWORD_RESET_COMPLETED',
        'USER_MFA_TOTP_ENABLED','USER_MFA_PREFERENCE_CHANGED','USER_MFA_TOTP_REVOKED',
        'MYDIGITALID_LINKED','LOGIN_SECURITY_WARNING',
    ];
