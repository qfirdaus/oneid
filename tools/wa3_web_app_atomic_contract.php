...
$checks=[
    ...
    'administrator directory selects the environment URL'=>str_contains($database,"CASE WHEN :domain_environment='production' THEN s.production_domain ELSE s.sp_domain END AS sp_domain")&&str_contains($database,"':domain_environment'=>\$this->environment"),
