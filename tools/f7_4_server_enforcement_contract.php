...
$map=oneid_q_func_action_map();$tests['inventory_48']=count($map['admin'])===48&&count(array_unique($map['admin']))===48;
...
$tests['ordinary_admin_access']=count(array_filter($map['admin'],fn($a)=>oneid_admin_action_purpose($a)==='ADMIN_ACCESS'))===44;
