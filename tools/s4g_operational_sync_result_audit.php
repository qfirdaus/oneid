...
/** Read-only, PII-redacted reconciliation for one completed operational sync. */
...
$detail=sprintf('ADMIN_SYNC_OPERATIONAL_SAFE header=%d new=%d updated=%d deactivated=%d reactivated=%d',$values['header'],$values['new'],$values['update'],$values['deactivate'],$values['reactivate']);
