...
$ok(str_contains($guard,"['check_default_password','action_change_password','action_set_initial_password']")&&str_contains($guard,"'UC3_PASSWORD_CHANGE_REQUIRED'"),'only status and password setup/change actions remain available while forced');
