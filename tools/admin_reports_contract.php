...
$checks['Users Access Applications and Session Activity reports are implemented']=$ready===['executive_summary','users_by_category','access_matrix','access_exceptions','application_readiness','application_acl_coverage','credential_rotation','session_activity'];
...
$checks['preview uses allowlisted report keys and eight data providers']=str_contains($preview,'AdminReportReference::resolve')&&str_contains($preview,'admin_report_executive_summary')&&str_contains($preview,'admin_report_users_by_category')&&str_contains($preview,'admin_report_category_access_matrix')&&str_contains($preview,'admin_report_access_exceptions')&&str_contains($preview,'admin_report_application_readiness')&&str_contains($preview,'admin_report_application_acl_coverage')&&str_contains($preview,'admin_report_site_api_credential_rotation')&&str_contains($preview,'admin_report_session_activity');
$checks['database provides the eight read-only report queries']=str_contains($database,'function admin_report_executive_summary')&&str_contains($database,'function admin_report_users_by_category')&&str_contains($database,'function admin_report_category_access_matrix')&&str_contains($database,'function admin_report_access_exceptions')&&str_contains($database,'function admin_report_application_readiness')&&str_contains($database,'function admin_report_application_acl_coverage')&&str_contains($database,'function admin_report_site_api_credential_rotation')&&str_contains($database,'function admin_report_session_activity');
