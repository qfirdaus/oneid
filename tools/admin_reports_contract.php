...
$checks['Users Access Applications Sessions and Synchronisation reports are implemented']=$ready===['executive_summary','users_by_category','access_matrix','access_exceptions','application_readiness','application_acl_coverage','credential_rotation','session_activity','device_summary','mfa_adoption','sync_runs','sync_changes','sync_exceptions'];
...
$providers=['executive_summary','users_by_category','category_access_matrix','access_exceptions','application_readiness','application_acl_coverage','site_api_credential_rotation','session_activity','device_summary','mfa_adoption','sync_runs','sync_changes','sync_exceptions'];
$checks['preview uses allowlisted report keys and thirteen data providers']=str_contains($preview,'AdminReportReference::resolve')&&array_reduce($providers,static fn(bool $ok,string $provider):bool=>$ok&&str_contains($preview,'admin_report_'.$provider),true);
$checks['database provides thirteen read-only report queries']=array_reduce($providers,static fn(bool $ok,string $provider):bool=>$ok&&str_contains($database,'function admin_report_'.$provider),true);
