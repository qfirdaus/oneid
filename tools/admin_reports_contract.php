...
$checks['Users and Access reports are fully implemented']=$ready===['executive_summary','users_by_category','access_matrix','access_exceptions','application_readiness'];
...
$checks['preview uses allowlisted report keys and five data providers']=str_contains($preview,'AdminReportReference::resolve')&&str_contains($preview,'admin_report_executive_summary')&&str_contains($preview,'admin_report_users_by_category')&&str_contains($preview,'admin_report_category_access_matrix')&&str_contains($preview,'admin_report_access_exceptions')&&str_contains($preview,'admin_report_application_readiness');
$checks['database provides the five read-only report queries']=str_contains($database,'function admin_report_executive_summary')&&str_contains($database,'function admin_report_users_by_category')&&str_contains($database,'function admin_report_category_access_matrix')&&str_contains($database,'function admin_report_access_exceptions')&&str_contains($database,'function admin_report_application_readiness');
