...
$report(str_contains($page,'oneid-faq-modal')&&str_contains($page,'oneid-user-faq.css?v=20260823-5'),'user dashboard loads the dedicated FAQ dialog design');
...
$report(str_contains($shared,'htmlspecialchars($entry[\'question\']')&&str_contains($shared,'htmlspecialchars(trim($paragraph)'),'FAQ content remains safely escaped');
