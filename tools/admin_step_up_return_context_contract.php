...
$expected=['active_sessions','configuration_admin_2fa','configuration_account_recovery','configuration_locale','configuration_login_banner','configuration_maintenance','configuration_maintenance_developer','configuration_user_mfa_security','configuration_user_mfa_category','configuration_user_mfa_exemption','admin_metadata'];sort($expected);$actual=array_keys($registry);sort($actual);
