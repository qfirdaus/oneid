...
$checks=[
 ...
 'purge confirmation uses the professional structured warning dialog'=>str_contains($dashboard,'oneid-archive-purge-alert')&&str_contains($dashboard,'oneid-archive-purge-risk')&&str_contains($dashboard,'oneid-archive-purge-field')&&str_contains($dashboard,"admin.archive.confirm_name")&&str_contains($dashboard,"admin.archive.reason_help"),
