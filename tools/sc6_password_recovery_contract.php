...
$ok(str_contains($q,'AUTH_PASSWORD_REQUIRED')&&str_contains($login,"swal('Log masuk tidak berjaya', 'Sila masukkan Kata Laluan.'")&&str_contains($login,"response['login_response_msg'] || 'ID Pengguna atau Kata Laluan tidak sah.'"),'empty password and authentication failures use explicit SweetAlert feedback');
