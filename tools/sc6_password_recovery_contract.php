...
$ok(str_contains($ui,"code==='STEP_UP_REQUIRED'")&&str_contains($ui,'return=account_recovery')&&str_contains($ui,"requestedConfiguration==='account_recovery'")&&str_contains($stepUp,"'account_recovery'=>APP_URL.'/admin/dashboard?configuration=account_recovery'")&&str_contains($stepUp,'location.replace(successRedirect)'),'recovery test handles security step-up and returns to the correct configuration tab');
