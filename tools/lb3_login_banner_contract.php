...
'LB3 mutation service stays outside public renderer while static fallback remains'=>!str_contains($index,'LoginBannerService')&&str_contains($security,'admin_login_banner')&&str_contains($index,'assetsM/images/banner_default.png'),
