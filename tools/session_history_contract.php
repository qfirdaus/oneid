...
'history filters use a full-width query and an untruncated reason layout'=>str_contains($ui,'.session-history-filter__query{grid-column:1/-1}')&&str_contains($ui,'minmax(240px,1.5fr) 112px 42px')&&str_contains($ui,'.session-history-filter__reason')&&str_contains($ui,'width: 130px'),
