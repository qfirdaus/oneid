...
$report(str_contains($appModalCss,'.oneid-app-info-footer{gap:9px;justify-content:flex-end}')&&str_contains($ui,'oneid-web-app-modal.css?v=20260812-6'),'App Info footer actions are right-aligned with refreshed styling');
...
$report(str_contains($ui,'oneid-direct-link-setting__title')&&str_contains($ui,'oneid-direct-link-setting__switch')&&str_contains($appModalCss,'input:checked~.oneid-direct-link-setting__switch')&&str_contains($ui,'oneid-web-app-modal.css?v=20260812-6'),'Direct Link uses a left-aligned card title and styled toggle switch');
