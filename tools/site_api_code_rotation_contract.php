...
$report(str_contains($appModalCss,'.oneid-app-info-footer{gap:9px;justify-content:flex-end}')&&str_contains($ui,'oneid-web-app-modal.css?v=20260814-2'),'App Info footer actions are right-aligned with refreshed styling');
...
$report(str_contains($ui,'oneid-app-card--access')&&str_contains($ui,'oneid-direct-link-setting__switch')&&str_contains($appModalCss,'input:checked~.oneid-direct-link-setting__switch')&&str_contains($ui,'oneid-web-app-modal.css?v=20260814-2'),'Direct Link uses a structured access card and styled toggle switch');
