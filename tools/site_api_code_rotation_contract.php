...
$report(str_contains($appModalCss,'.oneid-app-info-footer{gap:9px;justify-content:flex-end}')&&str_contains($ui,'oneid-web-app-modal.css?v=20260812-3'),'App Info footer actions are right-aligned with refreshed styling');
