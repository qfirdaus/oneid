                                          ...
                                          <div class="form-wrap">
                                             <div class="form-body overflow-hide">
                                                <div class="input-group mb-15">
                                                   ...
                                                   <span class="input-group-btn">
                                                   <button onclick="search_user_add_blacklist();" type="button" class="btn btn-orange btn-anim"><i class="icon-rocket"></i><span class="btn-text">Search</span></button>
                                                   </span> 
                                                </div>
                                                <hr/>
                                 ...
                                 <div class="panel-body pa-0">
                                    <div class="col-sm-12 col-xs-12">
                                       <div class="form-wrap">
                                          <div class="form-body overflow-hide">
                                             <div class="form-group">
                                                <button class="btn  btn-primary btn-outline btn-block" type="button" onclick="pick_add_sync_user();"><i class="fa fa-refresh"></i> Sync with external data</button>
                                             </div>
                                             <div class="form-group">
                                                   ...
                                                   <div class="col-lg-12">
                                                      <div class="panel-heading">
                                                                  ...
                                                                  <form class="form-inline">
                                                                     ...
                                                                     <button type="button" class="btn btn-orange btn-anim" onclick="search_audit_date_range()"><i class="icon-rocket"></i><span class="btn-text">Search</span></button>
                                                                  </form>
                           	...
                           	if(i == 0){
                           		...
                           		$.each( response[i]['data'], function( k, value ) {
                           			...
                           			if(response[i]['data'][k]['sp_sso_support']=="0"){
                           				div += '<div class="user-data"><span class="name block capitalize-font"><span class="label label-primary">'+(k+1)+'</span> <b>'+response[i]['data'][k]['sp_name']+'</b></span><span class="time  txt-grey">'+response[i]['data'][k]['sp_description']+'</span><br/><span class="time  txt-primary">URL : '+response[i]['data'][k]['sp_domain']+'</span></div>';
                           			}else{
                           				div += '<div class="user-data"><span class="name block capitalize-font"><span class="label label-primary">'+(k+1)+'</span> <b>'+response[i]['data'][k]['sp_name']+' <span class="label label-warning">SSO Not Supported</span></b></span><span class="time  txt-grey">'+response[i]['data'][k]['sp_description']+'</span><br/><span class="time  txt-primary">URL : '+response[i]['data'][k]['sp_domain']+'</span></div>';
                           			}
                           			
                           			div += '<button class="btn btn-primary pull-right btn-xs fixed-btn  btn-anim" onclick="open_edit_webapp(&quot;'+response[i]['data'][k]['sp_id']+'&quot;);"><i class="fa fa-edit"></i><span class="btn-text">View</span></button>';
         ...
         beforeSend: function(){
                     ...
                     success: function (response) {
                     	...
                     	$.each( response, function( i, value ) {
                     		...
                     		tr += '<button class="btn btn-primary pull-right btn-xs fixed-btn  btn-anim" onclick="view_category_user_list(&quot;'+response[i]['uc_id']+'&quot;,&quot;'+response[i]['uc_name']+'&quot;);"><i class="fa fa-external-link"></i><span class="btn-text">User ('+response[i]['total']+')</span></button><button class="btn btn-primary pull-right btn-xs fixed-btn  btn-anim" onclick="open_category_listing(&quot;'+response[i]['uc_id']+'&quot;,&quot;'+response[i]['uc_name']+'&quot;);"><i class="fa fa-external-link"></i><span class="btn-text">App List ('+response[i]['site_count']+')</span></button>';
           	...
           	$.ajax({
           		...
           		success: function (response) {       
           			...
           			switch(response['source']){
         				...
         				$('#modal_user_profile_id').val(response['u_id']);
         		...
         		var list_count = 0;
                       	...
                       	$.each( response, function( i, value ) {
                       		...
                       		if(response[i]['current_token']=="1"){
                       			...
                       			tr += '<div class="user-data"><span class="name block capitalize-font">'+(i+1)+'. '+response[i]['name']+' currently on : '+response[i]['device_info']+' '+current_session+'</span></div>';
         		            // tr += '<button class="btn btn-default pull-right btn-xs fixed-btn " ><span class="btn-text">Current</span></button>';
         
         		        }else{
         		        	tr += '<div class="user-data"><span class="name block capitalize-font">'+(i+1)+'. '+response[i]['name']+' on : '+response[i]['device_info']+' '+current_session+'</span></div>';
