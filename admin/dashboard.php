                                                               ...
                                                               <div class="tab-pane fade" id="user_2fa_exemption_panel" role="tabpanel" aria-labelledby="user_2fa_exemption_tab">
                                                                  <div class="sso-config-panel">
                                                                     <div class="sso-config-header">
                                                                        ...
                                                                        <button class="sso-config-save" id="user_2fa_exemption_create_button" type="button" onclick="createUser2faExemption();"><i class="fa fa-plus"></i> <?=htmlspecialchars(oneid_translate('admin.configuration.user_2fa_exemption_create'), ENT_QUOTES, 'UTF-8')?></button>
                                                                     </div>
                                                                     <div class="sso-config-body">
                                                                        <div class="sso-config-row"><div class="sso-config-copy"><span class="sso-config-index">01</span><div><label for="user_2fa_exemption_user"><?=htmlspecialchars(oneid_translate('admin.configuration.user_2fa_exemption_user'), ENT_QUOTES, 'UTF-8')?></label><p><?=htmlspecialchars(oneid_translate('admin.configuration.user_2fa_exemption_user_help'), ENT_QUOTES, 'UTF-8')?></p></div></div><div class="sso-config-control"><input class="form-control" id="user_2fa_exemption_user" maxlength="20" autocomplete="off"></div></div>
                                                                        <div class="sso-config-row"><div class="sso-config-copy"><span class="sso-config-index">02</span><div><label for="user_2fa_exemption_duration"><?=htmlspecialchars(oneid_translate('admin.configuration.user_2fa_exemption_duration'), ENT_QUOTES, 'UTF-8')?></label></div></div><div class="sso-config-control"><select class="form-control" id="user_2fa_exemption_duration"><option value="1">1 jam / hour</option><option value="4">4 jam / hours</option><option value="8">8 jam / hours</option><option value="24">24 jam / hours</option><option value="72">72 jam / hours (maximum)</option></select></div></div>
                                                                        <div class="sso-config-row"><div class="sso-config-copy"><span class="sso-config-index">03</span><div><label for="user_2fa_exemption_reason"><?=htmlspecialchars(oneid_translate('admin.configuration.locale_reason'), ENT_QUOTES, 'UTF-8')?></label></div></div><div class="sso-config-control"><textarea class="form-control" id="user_2fa_exemption_reason" maxlength="500" rows="2"></textarea></div></div>
                                                                        <div class="sso-config-row"><div class="sso-config-copy"><span class="sso-config-index">04</span><div><label for="user_2fa_exemption_reference"><?=htmlspecialchars(oneid_translate('admin.configuration.user_mfa_reference'), ENT_QUOTES, 'UTF-8')?></label></div></div><div class="sso-config-control"><input class="form-control" id="user_2fa_exemption_reference" maxlength="100"></div></div>
                                                                        <div class="sso-config-row"><div class="sso-config-copy"><span class="sso-config-index">05</span><div><label for="user_2fa_exemption_control"><?=htmlspecialchars(oneid_translate('admin.configuration.user_2fa_exemption_control'), ENT_QUOTES, 'UTF-8')?></label><p><?=htmlspecialchars(oneid_translate('admin.configuration.user_2fa_exemption_control_help'), ENT_QUOTES, 'UTF-8')?></p></div></div><div class="sso-config-control"><textarea class="form-control" id="user_2fa_exemption_control" maxlength="500" rows="2"></textarea></div></div>
                                                                        <div class="sso-config-row"><div class="sso-config-copy"><span class="sso-config-index">06</span><div><label for="user_2fa_exemption_confirmation"><?=htmlspecialchars(oneid_translate('admin.configuration.user_mfa_confirmation'), ENT_QUOTES, 'UTF-8')?></label><p><strong id="user_2fa_exemption_confirmation_phrase"></strong></p></div></div><div class="sso-config-control"><input class="form-control" id="user_2fa_exemption_confirmation" autocomplete="off"><button type="button" class="btn btn-default btn-sm mt-10" onclick="fillUser2faExemptionConfirmation();"><i class="fa fa-copy"></i> <?=htmlspecialchars(oneid_translate('admin.configuration.user_mfa_use_confirmation'), ENT_QUOTES, 'UTF-8')?></button></div></div>
