<?php
   ...
   try {
      ...
      $approved_release_notes = $approved_release_catalogue->forLocale(oneid_current_locale())['releases'];
   } catch (\Throwable $release_catalogue_error) {
      error_log('Release catalogue unavailable: ' . get_class($release_catalogue_error));
...
<html lang="<?=htmlspecialchars(oneid_current_locale(), ENT_QUOTES, 'UTF-8')?>">
   <head>
      ...
      <link href="../dist/css/oneid-login-banner-admin.css?v=20260910-2" rel="stylesheet" type="text/css">
   ...
   <body class="<?=trim(oneid_environment_body_class())?>">
      ...
      <?php $maintenanceAdminPolicy=\OneId\App\Maintenance\MaintenancePolicy::evaluate($operation->get_maintenance_config()?:[]); if($maintenanceAdminPolicy['active']): ?><div style="position:fixed;z-index:99999;top:0;left:0;right:0;background:#a94442;color:#fff;text-align:center;padding:7px;font-weight:700"><?=htmlspecialchars(oneid_translate('admin.maintenance.active_banner'), ENT_QUOTES, 'UTF-8')?></div><?php endif; ?>
      <!--Preloader-->
                     ...
                     <div class="modal-body oneid-sync-child-body oneid-metadata-body">
                        ...
                        <div class="row">
                           <div class="col-sm-4 form-group">
                              <label for="metadata_entity_type"><?=htmlspecialchars(oneid_translate('admin.metadata.entity_type'), ENT_QUOTES, 'UTF-8')?></label>
                           ...
                           <div class="col-sm-5 form-group">
                              <label for="metadata_entity_id"><?=htmlspecialchars(oneid_translate('admin.metadata.entity_record'), ENT_QUOTES, 'UTF-8')?></label>
                        ...
                        <section class="oneid-metadata-original" aria-labelledby="metadata_original_heading">
                           <div class="oneid-metadata-original-header">
                              <h6 id="metadata_original_heading"><?=htmlspecialchars(oneid_translate('admin.metadata.original_panel'), ENT_QUOTES, 'UTF-8')?></h6>
                              <span id="metadata_record_state" class="oneid-metadata-state"></span>
                           </div>
                           <dl>
                              <div><dt><?=htmlspecialchars(oneid_translate('admin.metadata.original_name'), ENT_QUOTES, 'UTF-8')?></dt><dd id="metadata_original_name">—</dd></div>
                              <div id="metadata_original_description_row"><dt><?=htmlspecialchars(oneid_translate('admin.metadata.original_description'), ENT_QUOTES, 'UTF-8')?></dt><dd id="metadata_original_description">—</dd></div>
                           </dl>
                        </section>
                        <div class="form-group">
                                             ...
                                             <div class="oneid-app-tab-shell">
                                                ...
                                                <section class="oneid-app-card oneid-app-card--identity">
                                                   ...
                                                   <div class="oneid-app-card__content">
                                                      <div class="form-group"><label for="edit_app_name">App Name</label><input type="text" class="form-control" id="edit_app_name" name="edit_app_name" placeholder="Name of the application"></div>
                                                      <div class="form-group"><label for="edit_app_desc">Description</label><textarea class="form-control" rows="3" id="edit_app_desc" name="edit_app_desc" placeholder="Describe what the app does"></textarea></div>
                                                      <div class="form-group"><label for="edit_app_category">App Category</label><select class="form-control" id="edit_app_category" name="edit_app_category"></select></div>
                                                   </div>
                                                </section>
                                                <section class="oneid-app-card oneid-app-card--branding">
                                                   <div class="oneid-app-card__heading"><span><i class="fa fa-picture-o"></i></span><div><h6>Application Icon</h6><p>Branding shown in the user directory.</p></div></div>
                                                   <div class="oneid-app-card__content">
                                                ...
                                                <section class="oneid-app-card oneid-app-card--environment">
                                                   ...
                                                   <div class="oneid-app-card__content oneid-environment-fields">
                                                      <div class="form-group oneid-environment-field"><div class="oneid-environment-label"><span class="oneid-environment-dot oneid-environment-dot--staging"></span><label for="edit_app_url">Staging URL</label><small>Available for testing</small></div><input type="text" class="form-control" id="edit_app_url" name="edit_app_url" placeholder="https://application-uat.upnm.edu.my"><small class="help-block oneid-app-url-help"><i class="fa fa-lock"></i> Secure HTTPS URL used in staging.</small></div>
                                                      <div class="form-group oneid-environment-field oneid-environment-field--production"><div class="oneid-environment-label"><span class="oneid-environment-dot oneid-environment-dot--production"></span><label for="edit_app_production_url">Production URL</label><small>Used after release</small></div><input type="text" class="form-control" id="edit_app_production_url" name="edit_app_production_url" placeholder="https://application.upnm.edu.my"><small class="help-block"><i class="fa fa-lock"></i> Required before production readiness can be enabled.</small></div>
                                                ...
                                                <section class="oneid-app-card oneid-app-card--access">
                                 ...
                                 <div class="panel-body  pa-0">
                                    ...
                                    <div class="pills-struct vertical-pills oneid-admin-sidebar-menu">
                                       <ul role="tablist" class="nav nav-pills ver-nav-pills oneid-sidebar-nav" id="myTabs_8">
                                          ...
                                          <li role="presentation" class="next"><a aria-expanded="true" data-toggle="tab" role="tab" id="tab_reports_menu" href="#tab_reports"><i class="fa fa-file-text-o oneid-sidebar-icon" aria-hidden="true"></i><span><?=htmlspecialchars(oneid_translate('admin.menu.reports'),ENT_QUOTES,'UTF-8')?></span></a></li>
                                    ...
                                    <div class="tab-content" id="myTabContent_8">
                                                ...
                                                <div class="row">
                                                   <div class="col-lg-12">
                                                      <div class="active-session-panel">
                                                         ...
                                                         <div class="session-view-tabs" role="tablist"><button type="button" class="is-active" id="session_view_active" role="tab" aria-selected="true"><i class="fa fa-bolt"></i> <?=htmlspecialchars(oneid_translate('admin.sessions.active_tab'),ENT_QUOTES,'UTF-8')?></button><button type="button" id="session_view_history" role="tab" aria-selected="false"><i class="fa fa-history"></i> <?=htmlspecialchars(oneid_translate('admin.sessions.history_tab'),ENT_QUOTES,'UTF-8')?></button></div>
                                                         ...
                                                         <div class="active-session-card session-history-card" id="session_history_list" hidden>
                                                            <div class="active-session-card-heading"><div><h5><?=htmlspecialchars(oneid_translate('admin.sessions.history_title'),ENT_QUOTES,'UTF-8')?></h5><p><?=htmlspecialchars(oneid_translate('admin.sessions.history_intro'),ENT_QUOTES,'UTF-8')?></p></div></div>
                                                            <div class="active-session-filter session-history-filter" role="search"><div class="active-session-search-box session-history-filter__query"><i class="fa fa-search"></i><input type="search" id="session_history_query" maxlength="80" placeholder="<?=htmlspecialchars(oneid_translate('admin.sessions.search'),ENT_QUOTES,'UTF-8')?>"></div><input class="session-history-filter__date" type="date" id="session_history_from" aria-label="<?=htmlspecialchars(oneid_translate('admin.sessions.date_from'),ENT_QUOTES,'UTF-8')?>"><input class="session-history-filter__date" type="date" id="session_history_to" aria-label="<?=htmlspecialchars(oneid_translate('admin.sessions.date_to'),ENT_QUOTES,'UTF-8')?>"><select class="session-history-filter__reason" id="session_history_reason"><option value="all"><?=htmlspecialchars(oneid_translate('admin.sessions.all_end_reasons'),ENT_QUOTES,'UTF-8')?></option><option value="USER_LOGOUT"><?=htmlspecialchars(oneid_translate('admin.sessions.end_USER_LOGOUT'),ENT_QUOTES,'UTF-8')?></option><option value="NEW_LOGIN_REPLACED"><?=htmlspecialchars(oneid_translate('admin.sessions.end_NEW_LOGIN_REPLACED'),ENT_QUOTES,'UTF-8')?></option><option value="PASSWORD_RESET"><?=htmlspecialchars(oneid_translate('admin.sessions.end_PASSWORD_RESET'),ENT_QUOTES,'UTF-8')?></option><option value="ADMIN_REVOKED"><?=htmlspecialchars(oneid_translate('admin.sessions.end_ADMIN_REVOKED'),ENT_QUOTES,'UTF-8')?></option><option value="UNKNOWN"><?=htmlspecialchars(oneid_translate('admin.sessions.end_UNKNOWN'),ENT_QUOTES,'UTF-8')?></option></select><select class="session-history-filter__size" id="session_history_page_size"><option value="10">10 <?=htmlspecialchars(oneid_translate('admin.sessions.per_page'),ENT_QUOTES,'UTF-8')?></option><option value="25">25 <?=htmlspecialchars(oneid_translate('admin.sessions.per_page'),ENT_QUOTES,'UTF-8')?></option><option value="50">50 <?=htmlspecialchars(oneid_translate('admin.sessions.per_page'),ENT_QUOTES,'UTF-8')?></option></select><button type="button" id="session_history_search" class="active-session-filter-button session-history-filter__submit"><i class="fa fa-search"></i></button></div>
                                                            <div class="active-session-table-wrap"><table class="table active-session-table session-history-table mb-0"><colgroup><col class="session-history-col-user"><col class="session-history-col-activity"><col class="session-history-col-device"><col class="session-history-col-reason"></colgroup><thead><tr><th><?=htmlspecialchars(oneid_translate('admin.sessions.user'),ENT_QUOTES,'UTF-8')?></th><th><?=htmlspecialchars(oneid_translate('admin.sessions.activity'),ENT_QUOTES,'UTF-8')?></th><th><?=htmlspecialchars(oneid_translate('admin.sessions.device'),ENT_QUOTES,'UTF-8')?></th><th><?=htmlspecialchars(oneid_translate('admin.sessions.end_reason'),ENT_QUOTES,'UTF-8')?></th></tr></thead><tbody id="session_history_rows"></tbody></table></div><div id="session_history_pagination" class="active-session-pagination"></div>
                                                         </div>
                                                      </div>
                                                   </div>
                                                </div>
										  ...
										  <div id="tab_reports" class="tab-pane fade in" role="tabpanel">
                                             <div class="admin-report-panel">
                                                <header class="admin-report-header"><div><span><?=htmlspecialchars(oneid_translate('admin.reports.eyebrow'),ENT_QUOTES,'UTF-8')?></span><h4><?=htmlspecialchars(oneid_translate('admin.reports.title'),ENT_QUOTES,'UTF-8')?></h4><p><?=htmlspecialchars(oneid_translate('admin.reports.intro'),ENT_QUOTES,'UTF-8')?></p></div><em><?=count($admin_report_groups)?> <?=htmlspecialchars(oneid_translate('admin.reports.groups'),ENT_QUOTES,'UTF-8')?></em></header>
                                                <ul class="nav admin-report-tabs" role="tablist">
                                                   ...
                                                   <li class="<?=$report_group_index===0?'active':''?>" role="presentation"><a href="#report_group_<?=htmlspecialchars($report_group_key,ENT_QUOTES,'UTF-8')?>" data-toggle="tab" role="tab" title="<?=htmlspecialchars(oneid_translate('admin.reports.group.'.$report_group_key),ENT_QUOTES,'UTF-8')?>"><i class="fa <?=htmlspecialchars($report_group['icon'],ENT_QUOTES,'UTF-8')?>"></i><span><?=htmlspecialchars(oneid_translate('admin.reports.group.'.$report_group_key),ENT_QUOTES,'UTF-8')?></span></a></li>
                                                ...
                                                <div class="tab-content admin-report-content">
                                                   ...
                                                   <section id="report_group_<?=htmlspecialchars($report_group_key,ENT_QUOTES,'UTF-8')?>" class="tab-pane fade <?=$report_group_index===0?'active in':''?>" role="tabpanel">
                                                      <div class="admin-report-group-heading"><div><i class="fa <?=htmlspecialchars($report_group['icon'],ENT_QUOTES,'UTF-8')?>"></i></div><span><strong><?=htmlspecialchars(oneid_translate('admin.reports.group.'.$report_group_key),ENT_QUOTES,'UTF-8')?></strong><small><?=htmlspecialchars(oneid_translate('admin.reports.group_intro'),ENT_QUOTES,'UTF-8')?></small></span></div>
                                                      <div class="admin-report-table-wrap"><table class="admin-report-table"><thead><tr><th><?=htmlspecialchars(oneid_translate('admin.reports.number'),ENT_QUOTES,'UTF-8')?></th><th><?=htmlspecialchars(oneid_translate('admin.reports.report_name'),ENT_QUOTES,'UTF-8')?></th><th><?=htmlspecialchars(oneid_translate('admin.reports.action'),ENT_QUOTES,'UTF-8')?></th></tr></thead><tbody>
                                                      <?php foreach($report_group['reports'] as$report_index=>$catalogue_report):$report_ready=$catalogue_report['status']==='ready';?>
                                                         <tr><td><?=($report_index+1)?></td><td><strong><?=htmlspecialchars(oneid_translate('admin.reports.report.'.$catalogue_report['key'].'.name'),ENT_QUOTES,'UTF-8')?></strong><small><?=htmlspecialchars(oneid_translate('admin.reports.report.'.$catalogue_report['key'].'.description'),ENT_QUOTES,'UTF-8')?></small></td><td><?php if($report_ready):?><button type="button" class="admin-report-view" data-report-key="<?=htmlspecialchars($catalogue_report['key'],ENT_QUOTES,'UTF-8')?>"><i class="fa fa-eye"></i> <?=htmlspecialchars(oneid_translate('admin.reports.view'),ENT_QUOTES,'UTF-8')?></button><?php else:?><span class="admin-report-planned"><i class="fa fa-clock-o"></i> <?=htmlspecialchars(oneid_translate('admin.reports.planned'),ENT_QUOTES,'UTF-8')?></span><?php endif;?></td></tr>
                                                ...
                                                <div class="row">
                                                   <div class="col-lg-12">
                                                      ...
                                                      <div class="configuration-secondary-navigation">
                                                         <nav data-configuration-subtabs="general" aria-label="<?=htmlspecialchars(oneid_translate('admin.configuration.general_group'), ENT_QUOTES, 'UTF-8')?>"><ul class="nav nav-pills"><li class="active"><a href="#configuration_locale" id="configuration_locale_tab" role="tab" data-toggle="tab" aria-controls="configuration_locale" aria-selected="true"><i class="fa fa-language"></i> <?=htmlspecialchars(oneid_translate('admin.configuration.locale_tab'), ENT_QUOTES, 'UTF-8')?></a></li><li><a href="#configuration_login_banner" id="configuration_login_banner_tab" role="tab" data-toggle="tab" aria-controls="configuration_login_banner" aria-selected="false"><i class="fa fa-picture-o"></i> <?=htmlspecialchars(oneid_translate('admin.banner.tab'), ENT_QUOTES, 'UTF-8')?></a></li><li><a href="#configuration_maintenance" id="configuration_maintenance_tab" role="tab" data-toggle="tab" aria-controls="configuration_maintenance" aria-selected="false"><i class="fa fa-wrench"></i> <?=htmlspecialchars(oneid_translate('admin.maintenance.tab'), ENT_QUOTES, 'UTF-8')?></a></li><li><a href="#configuration_maintenance_developer" id="configuration_maintenance_developer_tab" role="tab" data-toggle="tab" aria-controls="configuration_maintenance_developer" aria-selected="false"><i class="fa fa-code"></i> <?=htmlspecialchars(oneid_translate('admin.maintenance_developer.tab'), ENT_QUOTES, 'UTF-8')?></a></li></ul></nav>
                                                      ...
                                                      <div class="sso-config-panel">
                                                         ...
                                                         <section class="tab-pane fade" id="configuration_user_mfa" role="tabpanel" aria-labelledby="configuration_user_mfa_tab">
                                                            <ul class="nav nav-tabs user-2fa-subtabs" role="tablist" aria-label="<?=htmlspecialchars(oneid_translate('admin.configuration.user_2fa_sections'), ENT_QUOTES, 'UTF-8')?>">
                                                               ...
                                                               <li role="presentation"><a href="#user_2fa_exemption_panel" id="user_2fa_exemption_tab" role="tab" data-toggle="tab" aria-controls="user_2fa_exemption_panel" aria-selected="false"><i class="fa fa-clock-o"></i> <?=htmlspecialchars(oneid_translate('admin.configuration.user_2fa_exemption_tab'), ENT_QUOTES, 'UTF-8')?></a></li>
                                                            </ul>
                                                            ...
                                                            <div class="sso-config-panel">
                                                               ...
                                                               <div class="tab-pane fade" id="user_2fa_exemption_panel" role="tabpanel" aria-labelledby="user_2fa_exemption_tab">
                                                                  <div class="sso-config-panel">
                                                                     <div class="sso-config-header">
                                                                        <div><span class="sso-config-eyebrow"><?=htmlspecialchars(oneid_translate('admin.configuration.user_2fa_exemption_eyebrow'), ENT_QUOTES, 'UTF-8')?></span><h4 class="sso-config-title"><?=htmlspecialchars(oneid_translate('admin.configuration.user_2fa_exemption_title'), ENT_QUOTES, 'UTF-8')?></h4><p class="sso-config-intro"><?=htmlspecialchars(oneid_translate('admin.configuration.user_2fa_exemption_intro'), ENT_QUOTES, 'UTF-8')?></p></div>
                                                         ...
                                                         <section class="tab-pane fade" id="configuration_maintenance" role="tabpanel" aria-labelledby="configuration_maintenance_tab">
                                                            <div class="sso-config-panel maintenance-config-panel">
                                                               <div class="sso-config-header"><div><span class="sso-config-eyebrow"><?=htmlspecialchars(oneid_translate('admin.maintenance.eyebrow'), ENT_QUOTES, 'UTF-8')?></span><h4 class="sso-config-title"><?=htmlspecialchars(oneid_translate('admin.maintenance.title'), ENT_QUOTES, 'UTF-8')?></h4><p class="sso-config-intro"><?=htmlspecialchars(oneid_translate('admin.maintenance.intro'), ENT_QUOTES, 'UTF-8')?></p></div><button class="sso-config-save" id="maintenance_save" type="button" onclick="saveMaintenanceConfiguration();"><i class="fa fa-check"></i> <?=htmlspecialchars(oneid_translate('admin.maintenance.review_save'), ENT_QUOTES, 'UTF-8')?></button></div>
                                                               <div class="sso-config-body maintenance-config-body">
                                                                  <div class="maintenance-status-card"><span class="maintenance-status-card__icon"><i class="fa fa-shield"></i></span><div><span><?=htmlspecialchars(oneid_translate('admin.maintenance.current_status'), ENT_QUOTES, 'UTF-8')?></span><strong id="maintenance_status"><?=htmlspecialchars(oneid_translate('admin.common.loading'), ENT_QUOTES, 'UTF-8')?></strong></div></div>
                                                                  <div class="maintenance-form-grid">
                                                                     <section class="maintenance-form-card maintenance-form-card--mode"><div class="maintenance-form-card__heading"><span>01</span><div><label for="maintenance_mode"><?=htmlspecialchars(oneid_translate('admin.maintenance.mode'), ENT_QUOTES, 'UTF-8')?></label><p><?=htmlspecialchars(oneid_translate('admin.maintenance.mode_help'), ENT_QUOTES, 'UTF-8')?></p></div></div><select class="form-control" id="maintenance_mode"><option value="OFF"><?=htmlspecialchars(oneid_translate('admin.maintenance.mode_off'), ENT_QUOTES, 'UTF-8')?></option><option value="SCHEDULED"><?=htmlspecialchars(oneid_translate('admin.maintenance.mode_scheduled'), ENT_QUOTES, 'UTF-8')?></option><option value="INDEFINITE"><?=htmlspecialchars(oneid_translate('admin.maintenance.mode_indefinite'), ENT_QUOTES, 'UTF-8')?></option></select></section>
                                                                     <section class="maintenance-form-card" id="maintenance_time_row"><div class="maintenance-form-card__heading"><span>02</span><div><label><?=htmlspecialchars(oneid_translate('admin.maintenance.period'), ENT_QUOTES, 'UTF-8')?></label><p><?=htmlspecialchars(oneid_translate('admin.maintenance.period_help'), ENT_QUOTES, 'UTF-8')?></p></div></div><div class="maintenance-period-grid"><div><label for="maintenance_starts_at"><?=htmlspecialchars(oneid_translate('admin.maintenance.starts'), ENT_QUOTES, 'UTF-8')?></label><input class="form-control" type="datetime-local" id="maintenance_starts_at"></div><div id="maintenance_ends_wrap"><label for="maintenance_ends_at"><?=htmlspecialchars(oneid_translate('admin.maintenance.ends'), ENT_QUOTES, 'UTF-8')?></label><input class="form-control" type="datetime-local" id="maintenance_ends_at"></div></div></section>
                                                                     <section class="maintenance-form-card maintenance-form-card--wide"><div class="maintenance-form-card__heading"><span>03</span><div><label><?=htmlspecialchars(oneid_translate('admin.maintenance.public_message'), ENT_QUOTES, 'UTF-8')?></label><p><?=htmlspecialchars(oneid_translate('admin.maintenance.public_message_help'), ENT_QUOTES, 'UTF-8')?></p></div></div><div class="maintenance-language-grid"><fieldset><legend><span>BM</span> Bahasa Melayu</legend><label for="maintenance_title_ms"><?=htmlspecialchars(oneid_translate('admin.maintenance.message_title'), ENT_QUOTES, 'UTF-8')?></label><input class="form-control" id="maintenance_title_ms" maxlength="160" placeholder="<?=htmlspecialchars(oneid_translate('admin.maintenance.title_ms_placeholder'), ENT_QUOTES, 'UTF-8')?>"><label for="maintenance_message_ms"><?=htmlspecialchars(oneid_translate('admin.maintenance.message_body'), ENT_QUOTES, 'UTF-8')?></label><textarea class="form-control" id="maintenance_message_ms" maxlength="1000" rows="3" placeholder="<?=htmlspecialchars(oneid_translate('admin.maintenance.message_ms_placeholder'), ENT_QUOTES, 'UTF-8')?>"></textarea></fieldset><fieldset><legend><span>EN</span> English</legend><label for="maintenance_title_en"><?=htmlspecialchars(oneid_translate('admin.maintenance.message_title'), ENT_QUOTES, 'UTF-8')?></label><input class="form-control" id="maintenance_title_en" maxlength="160" placeholder="<?=htmlspecialchars(oneid_translate('admin.maintenance.title_en_placeholder'), ENT_QUOTES, 'UTF-8')?>"><label for="maintenance_message_en"><?=htmlspecialchars(oneid_translate('admin.maintenance.message_body'), ENT_QUOTES, 'UTF-8')?></label><textarea class="form-control" id="maintenance_message_en" maxlength="1000" rows="3" placeholder="<?=htmlspecialchars(oneid_translate('admin.maintenance.message_en_placeholder'), ENT_QUOTES, 'UTF-8')?>"></textarea></fieldset></div></section>
                                                                     <section class="maintenance-form-card maintenance-form-card--wide"><div class="maintenance-form-card__heading"><span>04</span><div><label><?=htmlspecialchars(oneid_translate('admin.maintenance.reason'), ENT_QUOTES, 'UTF-8')?></label><p><?=htmlspecialchars(oneid_translate('admin.maintenance.reason_help'), ENT_QUOTES, 'UTF-8')?></p></div></div><div class="maintenance-reason-options" role="radiogroup" aria-label="<?=htmlspecialchars(oneid_translate('admin.maintenance.reason'), ENT_QUOTES, 'UTF-8')?>"><button type="button" data-reason="Scheduled infrastructure maintenance"><i class="fa fa-calendar"></i><span><?=htmlspecialchars(oneid_translate('admin.maintenance.reason_scheduled'), ENT_QUOTES, 'UTF-8')?></span></button><button type="button" data-reason="Emergency security maintenance"><i class="fa fa-shield"></i><span><?=htmlspecialchars(oneid_translate('admin.maintenance.reason_security'), ENT_QUOTES, 'UTF-8')?></span></button><button type="button" data-reason="System upgrade and deployment"><i class="fa fa-cloud-upload"></i><span><?=htmlspecialchars(oneid_translate('admin.maintenance.reason_upgrade'), ENT_QUOTES, 'UTF-8')?></span></button><button type="button" data-reason="Database or infrastructure maintenance"><i class="fa fa-database"></i><span><?=htmlspecialchars(oneid_translate('admin.maintenance.reason_infrastructure'), ENT_QUOTES, 'UTF-8')?></span></button><button type="button" data-reason="Service stability investigation"><i class="fa fa-wrench"></i><span><?=htmlspecialchars(oneid_translate('admin.maintenance.reason_stability'), ENT_QUOTES, 'UTF-8')?></span></button><button type="button" data-reason="OTHER"><i class="fa fa-pencil"></i><span><?=htmlspecialchars(oneid_translate('admin.maintenance.reason_other'), ENT_QUOTES, 'UTF-8')?></span></button></div><div class="maintenance-other-reason" id="maintenance_other_reason_wrap" hidden><label for="maintenance_reason"><?=htmlspecialchars(oneid_translate('admin.maintenance.describe_reason'), ENT_QUOTES, 'UTF-8')?></label><textarea class="form-control" id="maintenance_reason" maxlength="500" rows="3" placeholder="<?=htmlspecialchars(oneid_translate('admin.maintenance.reason_placeholder'), ENT_QUOTES, 'UTF-8')?>"></textarea><small><?=htmlspecialchars(oneid_translate('admin.maintenance.reason_limit'), ENT_QUOTES, 'UTF-8')?></small></div></section>
                                                                  </div>
                                                                  <div class="maintenance-admin-note"><i class="fa fa-info-circle"></i><div><strong><?=htmlspecialchars(oneid_translate('admin.maintenance.admin_access_title'), ENT_QUOTES, 'UTF-8')?></strong><p><?=oneid_translate('admin.maintenance.admin_access_help')?></p></div></div>
                                                               </div>
                                                            </div>
                                                         </section>
                                                         <section class="tab-pane fade" id="configuration_maintenance_developer" role="tabpanel" aria-labelledby="configuration_maintenance_developer_tab">
                                                            <div class="sso-config-panel maintenance-developer-admin" data-api="../lib/q_func" data-csrf="<?=htmlspecialchars(oneid_csrf_token(), ENT_QUOTES, 'UTF-8')?>" data-step-up-url="../page/admin-step-up?purpose=SECURITY_CONFIGURATION_CHANGE&amp;return=configuration_maintenance_developer">
                                                               <div class="sso-config-header"><div><span class="sso-config-eyebrow"><?=htmlspecialchars(oneid_translate('admin.maintenance_developer.eyebrow'), ENT_QUOTES, 'UTF-8')?></span><h4 class="sso-config-title"><?=htmlspecialchars(oneid_translate('admin.maintenance_developer.title'), ENT_QUOTES, 'UTF-8')?></h4><p class="sso-config-intro"><?=htmlspecialchars(oneid_translate('admin.maintenance_developer.intro'), ENT_QUOTES, 'UTF-8')?></p></div><button type="button" class="sso-config-save" id="maintenance_developer_refresh"><i class="fa fa-refresh"></i> <?=htmlspecialchars(oneid_translate('admin.maintenance_developer.refresh'), ENT_QUOTES, 'UTF-8')?></button></div>
                                                               <div id="maintenance_developer_status" class="maintenance-developer-status" role="status" aria-live="polite"><span><i class="fa fa-shield"></i></span><div><small><?=htmlspecialchars(oneid_translate('admin.maintenance_developer.current_status'), ENT_QUOTES, 'UTF-8')?></small><strong><?=htmlspecialchars(oneid_translate('admin.common.loading'), ENT_QUOTES, 'UTF-8')?></strong></div></div>
                                                               <div class="maintenance-developer-workspace">
                                                                  <section class="maintenance-developer-card maintenance-developer-card--search"><div class="maintenance-developer-card__heading"><span>01</span><div><h5><?=htmlspecialchars(oneid_translate('admin.maintenance_developer.search'), ENT_QUOTES, 'UTF-8')?></h5><p><?=htmlspecialchars(oneid_translate('admin.maintenance_developer.search_help'), ENT_QUOTES, 'UTF-8')?></p></div></div><div class="maintenance-developer-search"><input class="form-control" id="maintenance_developer_query" maxlength="100" placeholder="<?=htmlspecialchars(oneid_translate('admin.maintenance_developer.search_placeholder'), ENT_QUOTES, 'UTF-8')?>"><button class="btn btn-primary" id="maintenance_developer_search" type="button"><i class="fa fa-search"></i> <?=htmlspecialchars(oneid_translate('admin.maintenance_developer.search_button'), ENT_QUOTES, 'UTF-8')?></button></div><div id="maintenance_developer_candidates" class="maintenance-developer-results" aria-live="polite"></div></section>
                                                                  <section class="maintenance-developer-card maintenance-developer-card--grant" id="maintenance_developer_grant_card" hidden><div class="maintenance-developer-card__heading"><span>02</span><div><h5><?=htmlspecialchars(oneid_translate('admin.maintenance_developer.configure'), ENT_QUOTES, 'UTF-8')?></h5><p id="maintenance_developer_selected"></p></div></div><input type="hidden" id="maintenance_developer_user_id"><input type="hidden" id="maintenance_developer_confirmation"><div class="maintenance-developer-period"><label><?=htmlspecialchars(oneid_translate('admin.maintenance_developer.period'), ENT_QUOTES, 'UTF-8')?></label><div class="maintenance-developer-duration"><button type="button" data-hours="1">1 <?=htmlspecialchars(oneid_translate('admin.maintenance_developer.hour'), ENT_QUOTES, 'UTF-8')?></button><button type="button" data-hours="2">2 <?=htmlspecialchars(oneid_translate('admin.maintenance_developer.hours'), ENT_QUOTES, 'UTF-8')?></button><button type="button" data-hours="4">4 <?=htmlspecialchars(oneid_translate('admin.maintenance_developer.hours'), ENT_QUOTES, 'UTF-8')?></button></div><div class="maintenance-developer-time-grid"><label><?=htmlspecialchars(oneid_translate('admin.maintenance_developer.valid_from'), ENT_QUOTES, 'UTF-8')?><input class="form-control" id="maintenance_developer_valid_from" type="datetime-local"></label><label><?=htmlspecialchars(oneid_translate('admin.maintenance_developer.valid_until'), ENT_QUOTES, 'UTF-8')?><input class="form-control" id="maintenance_developer_valid_until" type="datetime-local"></label></div></div><div class="maintenance-developer-reason"><label><?=htmlspecialchars(oneid_translate('admin.maintenance_developer.reason'), ENT_QUOTES, 'UTF-8')?></label><div class="maintenance-developer-reason-options"><button type="button" data-reason="Controlled maintenance access testing"><i class="fa fa-check-circle"></i><span><?=htmlspecialchars(oneid_translate('admin.maintenance_developer.reason_testing'), ENT_QUOTES, 'UTF-8')?></span></button><button type="button" data-reason="Application verification during maintenance"><i class="fa fa-desktop"></i><span><?=htmlspecialchars(oneid_translate('admin.maintenance_developer.reason_application'), ENT_QUOTES, 'UTF-8')?></span></button><button type="button" data-reason="Post-deployment maintenance validation"><i class="fa fa-cloud-upload"></i><span><?=htmlspecialchars(oneid_translate('admin.maintenance_developer.reason_deployment'), ENT_QUOTES, 'UTF-8')?></span></button><button type="button" data-reason="OTHER"><i class="fa fa-pencil"></i><span><?=htmlspecialchars(oneid_translate('admin.maintenance_developer.reason_other'), ENT_QUOTES, 'UTF-8')?></span></button></div><div id="maintenance_developer_reason_other" hidden><textarea class="form-control" id="maintenance_developer_reason" minlength="10" maxlength="500" rows="3" placeholder="<?=htmlspecialchars(oneid_translate('admin.maintenance_developer.reason_placeholder'), ENT_QUOTES, 'UTF-8')?>"></textarea></div></div><div class="maintenance-developer-reference"><label for="maintenance_developer_reference"><?=htmlspecialchars(oneid_translate('admin.maintenance_developer.reference'), ENT_QUOTES, 'UTF-8')?></label><p><?=htmlspecialchars(oneid_translate('admin.maintenance_developer.reference_help'), ENT_QUOTES, 'UTF-8')?></p><div class="input-group"><input class="form-control" id="maintenance_developer_reference" maxlength="100"><span class="input-group-btn"><button class="btn btn-default" id="maintenance_developer_generate_reference" type="button"><i class="fa fa-magic"></i> <?=htmlspecialchars(oneid_translate('admin.maintenance_developer.generate'), ENT_QUOTES, 'UTF-8')?></button></span></div></div><button class="sso-config-save maintenance-developer-review" id="maintenance_developer_grant" type="button"><i class="fa fa-eye"></i> <?=htmlspecialchars(oneid_translate('admin.maintenance_developer.review'), ENT_QUOTES, 'UTF-8')?></button></section>
                                                               </div>
                                                               <section class="maintenance-developer-card maintenance-developer-card--records"><div class="maintenance-developer-card__heading"><span>03</span><div><h5><?=htmlspecialchars(oneid_translate('admin.maintenance_developer.active_grants'), ENT_QUOTES, 'UTF-8')?></h5><p><?=htmlspecialchars(oneid_translate('admin.maintenance_developer.grants_help'), ENT_QUOTES, 'UTF-8')?></p></div></div><div id="maintenance_developer_grants" class="maintenance-developer-results" aria-live="polite"></div></section>
                                                            </div>
                                                         </section>
                                                                  ...
                                                                  <form id="login_banner_draft_form" enctype="multipart/form-data">
                                                                     <fieldset><legend id="login_banner_form_title"><?=htmlspecialchars(oneid_translate('admin.banner.new_draft'), ENT_QUOTES, 'UTF-8')?></legend>
                                                                        <div class="login-banner-form-grid">
                                                                           ...
                                                                           <div class="form-group"><label for="login_banner_image_ms"><?=htmlspecialchars(oneid_translate('admin.banner.image_ms'), ENT_QUOTES, 'UTF-8')?></label><input class="form-control" id="login_banner_image_ms" name="banner_image_ms" type="file" accept="image/jpeg,image/png,image/webp" required><small class="help-block" id="login_banner_image_help"><?=htmlspecialchars(oneid_translate('admin.banner.image_help'), ENT_QUOTES, 'UTF-8')?></small></div>
                                                                        ...
                                                                        <button class="btn btn-primary" id="login_banner_create" type="submit"><i class="fa fa-plus"></i> <span id="login_banner_submit_label"><?=htmlspecialchars(oneid_translate('admin.banner.create'), ENT_QUOTES, 'UTF-8')?></span></button>
                                                                        <button class="btn btn-default" id="login_banner_cancel_edit" type="button" hidden><?=htmlspecialchars(oneid_translate('admin.banner.cancel_edit'), ENT_QUOTES, 'UTF-8')?></button>
                                                                     </fieldset>
                                                                  </form>
                                                                  <hr>
      ...
      window.OneIdAdminSessionConfig = <?=json_encode([
         ...
         'text' => [
            ...
            'portalRemainingLabel' => oneid_translate('user_session.remaining_label'),
            'adminRemainingLabel' => oneid_translate('admin.session.remaining_label'),
            'portalRenewFailedBody' => oneid_translate('user_session.request_failed'),
         ],
      ...
      <script>
         ...
         function adminEscapeHtml(value){return $('<div>').text(String(value==null?'':value)).html();}
         ...
         function loadMetadataTranslation(){
            ...
            var requestSequence=++metadataReadSequence;
            var requestedIdentity=[
               $('#metadata_entity_type').val(),
               $('#metadata_entity_id').val(),
               $('#metadata_locale').val()
            ].join(':');
            ...
            metadataReadRequest=$.post('../lib/q_func',{
               ...
               var currentIdentity=[$('#metadata_entity_type').val(),$('#metadata_entity_id').val(),$('#metadata_locale').val()].join(':');
               if(requestSequence!==metadataReadSequence||requestedIdentity!==currentIdentity){return;}
               if(response&&Number(response.status)===1){
                  ...
                  $('#metadata_original_name').text(data.original_name||'—');
                  $('#metadata_original_description').text(data.original_description||'—');
                  $('#metadata_record_state')
                     .text(data.translation_exists?adminI18n.metadataTranslated:adminI18n.metadataFallback)
                     .toggleClass('is-translated',!!data.translation_exists)
                     .toggleClass('is-fallback',!data.translation_exists);
         ...
         function openMetadataTranslations(){
            ...
            $.post('../lib/q_func',{admin_metadata_translation_preview:''},function(response){
               ...
               var coverage=response&&response.translations&&response.translations.by_locale?response.translations.by_locale:{};
               var ms=coverage.ms||{};var en=coverage.en||{};
               $('#metadata_translation_status').text(
                  (metadataSchemaAvailable?adminI18n.metadataReady:adminI18n.metadataDormant)
                  +' '+adminI18n.metadataCoverage+': BM — '
                  +adminI18n.metadataApps+' '+Number(ms.applications||0)+'/'+Number(source.applications||0)+', '
                  +adminI18n.metadataCategories+' '+Number(ms.categories||0)+'/'+Number(source.categories||0)
         ...
         function loadSystemDefaultLocale(){
            ...
            $.post('../lib/q_func',{admin_update_default_locale:'',default_locale:locale,configuration_version:systemDefaultLocaleVersion,change_reason:reason},function(response){
             ...
             function configurationGroupForTarget(target){
                if(target==='#configuration_locale'||target==='#configuration_login_banner'||target==='#configuration_maintenance'||target==='#configuration_maintenance_developer'){return 'general';}
             ...
             $('#tab_settings .configuration-secondary-navigation a[data-toggle="tab"]').on('show.bs.tab', function(){
                ...
                if(target==='#configuration_maintenance'){loadMaintenanceConfiguration();}
             });
         ...
         var maintenanceConfigurationVersion=0;
         var maintenanceSelectedReason='';
         var maintenanceStoredMode='OFF';
         var maintenanceStoredState='OFF';
         var maintenanceResumeAfterStepUp=<?=json_encode(($_GET['step_up_return'] ?? '') === 'configuration_maintenance')?>;
         ...
         function loadMaintenanceConfiguration(){$.post('../lib/q_func',{admin_get_maintenance_configuration:''},function(r){if(!r||Number(r.status)!==1){$('#maintenance_status').text(adminText('admin.maintenance.load_failed'));return;}var d=r.data||{};maintenanceConfigurationVersion=Number(d.configuration_version||0);maintenanceStoredMode=String(d.mode||'OFF');maintenanceStoredState=String(d.state||'OFF');$('#maintenance_mode').val(maintenanceStoredMode);$('#maintenance_starts_at').val(maintenanceLocalValue(d.starts_at));$('#maintenance_ends_at').val(maintenanceLocalValue(d.ends_at));$('#maintenance_title_ms').val(d.title_ms||'');$('#maintenance_title_en').val(d.title_en||'');$('#maintenance_message_ms').val(d.message_ms||'');$('#maintenance_message_en').val(d.message_en||'');$('#maintenance_status').text(maintenanceStatusText(maintenanceStoredState));toggleMaintenanceTimes();if(maintenanceResumeAfterStepUp){maintenanceResumeAfterStepUp=false;restoreMaintenanceDraftAfterStepUp();}},'json').fail(function(){$('#maintenance_status').text(adminText('admin.maintenance.load_failed'));});}
         function toggleMaintenanceTimes(){var mode=$('#maintenance_mode').val();$('#maintenance_time_row').toggle(mode!=='OFF').removeClass('maintenance-form-card--scheduled maintenance-form-card--indefinite').addClass(mode==='SCHEDULED'?'maintenance-form-card--scheduled':(mode==='INDEFINITE'?'maintenance-form-card--indefinite':''));$('#maintenance_ends_wrap').toggle(mode==='SCHEDULED');$('#maintenance_ends_at').prop('disabled',mode!=='SCHEDULED');$('#maintenance_status').text(mode!==maintenanceStoredMode?adminText('admin.maintenance.status_pending'):maintenanceStatusText(maintenanceStoredState));}
         ...
         function maintenanceDraft(data){return{mode:data.mode,starts_at:data.starts_at,ends_at:data.ends_at,title_ms:data.title_ms,title_en:data.title_en,message_ms:data.message_ms,message_en:data.message_en,selected_reason:maintenanceSelectedReason,change_reason:data.change_reason};}
         function storeMaintenanceDraft(data){try{sessionStorage.setItem('oneid_maintenance_step_up_draft',JSON.stringify(maintenanceDraft(data)));}catch(ignore){}}
         function clearMaintenanceDraft(){try{sessionStorage.removeItem('oneid_maintenance_step_up_draft');}catch(ignore){}}
         function restoreMaintenanceDraftAfterStepUp(){var draft=null;try{draft=JSON.parse(sessionStorage.getItem('oneid_maintenance_step_up_draft')||'null');}catch(ignore){}if(!draft||!draft.mode)return;$('#maintenance_mode').val(draft.mode);$('#maintenance_starts_at').val(draft.starts_at||'');$('#maintenance_ends_at').val(draft.ends_at||'');$('#maintenance_title_ms').val(draft.title_ms||'');$('#maintenance_title_en').val(draft.title_en||'');$('#maintenance_message_ms').val(draft.message_ms||'');$('#maintenance_message_en').val(draft.message_en||'');maintenanceSelectedReason=String(draft.selected_reason||'');$('.maintenance-reason-options button').removeClass('is-selected').attr('aria-checked','false');var selected=$('.maintenance-reason-options button').filter(function(){return String($(this).data('reason')||'')===maintenanceSelectedReason;}).first();selected.addClass('is-selected').attr('aria-checked','true');var other=maintenanceSelectedReason==='OTHER';$('#maintenance_other_reason_wrap').prop('hidden',!other);$('#maintenance_reason').val(other?String(draft.change_reason||''):'');toggleMaintenanceTimes();setTimeout(saveMaintenanceConfiguration,120);}
         function saveMaintenanceConfiguration(){
            if(!maintenanceSelectedReason){swal(adminText('admin.maintenance.reason_required_title'),adminText('admin.maintenance.reason_required'),'warning');return;}
            var reason=maintenanceSelectedReason==='OTHER'?$.trim($('#maintenance_reason').val()):maintenanceSelectedReason;
            if(maintenanceSelectedReason==='OTHER'&&(reason.length<10||reason.length>500)){swal(adminText('admin.maintenance.reason_required_title'),adminText('admin.maintenance.other_required'),'warning');return;}
            var data={admin_update_maintenance_configuration:'',mode:$('#maintenance_mode').val(),starts_at:$('#maintenance_starts_at').val(),ends_at:$('#maintenance_ends_at').val(),title_ms:$('#maintenance_title_ms').val(),title_en:$('#maintenance_title_en').val(),message_ms:$('#maintenance_message_ms').val(),message_en:$('#maintenance_message_en').val(),change_reason:reason,configuration_version:maintenanceConfigurationVersion};
            var modeLabel=$('#maintenance_mode option:selected').text();
            var warning=data.mode==='OFF'?adminText('admin.maintenance.warning_disable'):adminText('admin.maintenance.warning_enable');
            var review='<div class="maintenance-review-dialog"><p class="maintenance-review-dialog__intro">'+adminEscapeHtml(adminText('admin.maintenance.review_intro'))+'</p><div class="maintenance-review-dialog__summary"><div class="maintenance-review-dialog__row"><span>'+adminEscapeHtml(adminText('admin.maintenance.review_mode'))+'</span><strong>'+adminEscapeHtml(modeLabel)+'</strong></div><div class="maintenance-review-dialog__row"><span>'+adminEscapeHtml(adminText('admin.maintenance.review_reason'))+'</span><strong>'+adminEscapeHtml(reason)+'</strong></div></div><div class="maintenance-review-dialog__notice"><i class="fa fa-exclamation-triangle"></i><span>'+adminEscapeHtml(warning)+'</span></div></div>';
            swal({title:adminText('admin.maintenance.review_title'),text:review,html:true,type:'warning',showCancelButton:true,confirmButtonText:adminText('admin.maintenance.apply'),cancelButtonText:adminText('admin.maintenance.cancel'),closeOnConfirm:false,allowEscapeKey:false,allowOutsideClick:false},function(ok){
               if(!ok)return;
               $('.sweet-alert .confirm').prop('disabled',true).text(adminText('admin.maintenance.saving'));
               $.post('../lib/q_func',data,function(r){if(r&&Number(r.status)===1){clearMaintenanceDraft();maintenanceSelectedReason='';$('.maintenance-reason-options button').removeClass('is-selected').attr('aria-checked','false');$('#maintenance_reason').val('');$('#maintenance_other_reason_wrap').prop('hidden',true);swal(adminText('admin.maintenance.saved_title'),adminText('admin.maintenance.saved_body')+' '+r.correlation_id,'success');loadMaintenanceConfiguration();}else{swal(adminText('admin.maintenance.failed_title'),'Code: '+(r&&r.code?r.code:'MT3_FAILED'),'error');}},'json').fail(function(xhr){var code=xhr.responseJSON&&xhr.responseJSON.code?xhr.responseJSON.code:'';if(xhr.status===403&&String(code).indexOf('STEP_UP')===0){storeMaintenanceDraft(data);window.location.href='../page/admin-step-up?purpose=SECURITY_CONFIGURATION_CHANGE&return=configuration_maintenance';}else{swal(adminText('admin.maintenance.failed_title'),'HTTP '+xhr.status,'error');}});
            });
            apply_site_api_alert_layout('maintenance',adminText('admin.maintenance.eyebrow'));
         }
         ...
         $('#modal_category_user_list_view').modal('show');
           ...
           var archivePurgeModalFocusSuspended=false;
           function suspend_archive_purge_parent_focus(){if(archivePurgeModalFocusSuspended){return;}$(document).off('focusin.bs.modal');archivePurgeModalFocusSuspended=true;}
           function restore_archive_purge_parent_focus(){if(!archivePurgeModalFocusSuspended){return;}archivePurgeModalFocusSuspended=false;var modal=$('#modal_archived_webapps'),instance=modal.data('bs.modal');if(modal.hasClass('in')&&instance&&typeof instance.enforceFocus==='function'){instance.enforceFocus();}}
           $(document).on('click','.archived-app-purge:not(:disabled)',function(){
              var appId=String($(this).data('app-id')||''),appName=String($(this).data('app-name')||'');
              var purgePanel='<div class="oneid-archive-purge-panel">'+
                 '<div class="oneid-archive-purge-risk"><span><i class="fa fa-exclamation-triangle"></i></span><div><strong>'+webAppManagementText(adminText('admin.archive.risk_title'))+'</strong><small>'+webAppManagementText(adminText('admin.archive.purge_help'))+'</small></div></div>'+
                 '<div class="oneid-archive-purge-field"><label for="archive_purge_confirmation">'+webAppManagementText(adminText('admin.archive.confirm_name'))+'</label><small>'+webAppManagementText(adminText('admin.archive.confirm_help'))+'</small><div class="oneid-archive-purge-target"><i class="fa fa-archive"></i><strong>'+webAppManagementText(appName)+'</strong></div><input id="archive_purge_confirmation" class="form-control" autocomplete="off" placeholder="'+webAppManagementAttribute(appName)+'"></div>'+
                 '<div class="oneid-archive-purge-field"><label for="archive_purge_reason_option">'+webAppManagementText(adminText('admin.archive.reason_label'))+'</label><small>'+webAppManagementText(adminText('admin.archive.reason_help'))+'</small><select id="archive_purge_reason_option" class="form-control"><option value="">'+webAppManagementText(adminText('admin.archive.reason_select'))+'</option><option value="PREDEFINED">'+webAppManagementText(adminText('admin.archive.reason_test'))+'</option><option value="PREDEFINED">'+webAppManagementText(adminText('admin.archive.reason_duplicate'))+'</option><option value="PREDEFINED">'+webAppManagementText(adminText('admin.archive.reason_obsolete'))+'</option><option value="PREDEFINED">'+webAppManagementText(adminText('admin.archive.reason_uat'))+'</option><option value="OTHER">'+webAppManagementText(adminText('admin.archive.reason_other'))+'</option></select><div class="oneid-archive-purge-custom-reason"><label for="archive_purge_reason">'+webAppManagementText(adminText('admin.archive.reason_custom'))+'</label><textarea id="archive_purge_reason" class="form-control" rows="3" minlength="10" maxlength="500" placeholder="'+webAppManagementAttribute(adminText('admin.archive.reason'))+'" disabled></textarea></div></div>'+
              '</div>';
              suspend_archive_purge_parent_focus();
              swal({title:adminText('admin.archive.purge_title'),text:purgePanel,html:true,type:'warning',showCancelButton:true,confirmButtonColor:'#d9534f',confirmButtonText:adminText('admin.archive.purge_confirm'),cancelButtonText:adminText('admin.archive.cancel'),closeOnConfirm:false,allowOutsideClick:false},function(confirmed){
                 if(!confirmed){restore_archive_purge_parent_focus();return false;}
                 var confirmation=$('#archive_purge_confirmation').val()||'',reasonOption=$('#archive_purge_reason_option').val()||'',reason=reasonOption==='OTHER'?String($('#archive_purge_reason').val()||'').trim():String($('#archive_purge_reason_option option:selected').text()||'').trim();
                 if(confirmation!==appName||!reasonOption||String(reason).trim().length<10){swal.showInputError(adminText('admin.archive.validation'));return false;}
                 $.post('../lib/q_func',{admin_purge_archived_app:'',app_id:appId,confirmation:confirmation,reason:reason},function(response){
                    if(Number(response.status)===1){open_archived_webapps();swal({title:adminText('admin.archive.purged'),text:adminText('admin.archive.reference')+': '+response.correlation_id,type:'success'},restore_archive_purge_parent_focus);}
                    else swal({title:adminText('admin.archive.purge_blocked'),text:'Code: '+(response.code||'WA7_PURGE_FAILED')+'\n'+adminText('admin.archive.reference')+': '+(response.correlation_id||'Unavailable'),type:'error'},restore_archive_purge_parent_focus);
                 },'json');
                 return false;
              });
              $('.sweet-alert').addClass('oneid-archive-purge-alert');
              $('#archive_purge_reason_option').on('change',function(){var custom=$(this).val()==='OTHER';$('.oneid-archive-purge-custom-reason').toggle(custom);$('#archive_purge_reason').prop('disabled',!custom);if(custom){$('#archive_purge_reason').focus();}});
           });
         ...
         // edit_app_category
           ...
           function updateAppProductionReadinessUi(){
              var ready = $('#edit_app_production_ready').is(':checked');
              var $card = $('#modal_edit_app .oneid-app-card--environment');
			...
			beforeSend: function(){
				$('#modal_edit_app').modal('show');
           		...
           		success: function (response) {                
					...
					updateAppProductionReadinessUi();
           ...
           function apply_site_api_alert_layout(kind,eyebrowText){
              ...
              if(!alert){return;}
              alert.classList.remove('oneid-site-api-alert--rotation','oneid-site-api-alert--result','oneid-site-api-alert--maintenance');
              ...
              if(genericEyebrow){genericEyebrow.parentNode.removeChild(genericEyebrow);}
           ...
           window.oneidApplyProfessionalAlertLayout=apply_site_api_alert_layout;
         ...
         var sessionHistoryPage=1;
         var sessionHistoryLoaded=false;
         ...
         function load_session_history(page){
            ...
            var historyWatchdog=window.setTimeout(function(){$('#session_history_rows').html('<tr class="active-session-state-row is-error"><td colspan="4"><strong>'+adminText('admin.sessions.history_unavailable')+'</strong><small>SH1_REQUEST_TIMEOUT</small></td></tr>');},15000);
            $.post('../lib/q_func',{admin_get_session_history:'',page:String(sessionHistoryPage),page_size:String($('#session_history_page_size').val()||'10'),query:String($('#session_history_query').val()||'').trim(),reason:String($('#session_history_reason').val()||'all'),date_from:$('#session_history_from').val(),date_to:$('#session_history_to').val()},function(response){
               var esc=function(v){return $('<div>').text(v==null?'':String(v)).html();};
               if(!response||Number(response.status)!==1){window.clearTimeout(historyWatchdog);$('#session_history_rows').html('<tr class="active-session-state-row is-error"><td colspan="4"><strong>'+esc(adminText('admin.sessions.history_unavailable'))+'</strong><small>'+esc(response&&response.code?response.code:'SH1_HISTORY_FAILED')+'</small></td></tr>');return;}
               sessionHistoryLoaded=true;var rows='';
               $.each(response.data||[],function(_,s){
                  var idLabel=s.public_user_id_type==='staff'?adminText('admin.sessions.staff_no'):adminText('admin.sessions.matric_no');
                  var userName=String(s.name||''),publicUserId=String(s.public_user_id||'-'),issuedAt=admin_format_datetime(s.issued_at),endedAt=admin_format_datetime(s.ended_at||s.last_activity_at),deviceInfo=String(s.device_info||'-'),endReason=sessionEndLabel(s.end_reason);
                  var userTooltip=userName+' · '+idLabel+' '+publicUserId,activityTooltip=adminText('admin.sessions.issued')+': '+issuedAt+' · '+adminText('admin.sessions.ended')+': '+endedAt;
                  rows+='<tr>';
                  rows+='<td data-label="'+sessionAttributeValue(adminText('admin.sessions.user'))+'"><span class="active-session-user-copy" data-session-tooltip title="'+sessionAttributeValue(userTooltip)+'"><strong>'+esc(userName)+(s.is_admin?' <small class="session-history-admin">ADMIN</small>':'')+'</strong><small><span>'+esc(idLabel)+'</span>'+esc(publicUserId)+'</small></span></td>';
                  rows+='<td data-label="'+sessionAttributeValue(adminText('admin.sessions.activity'))+'"><span class="active-session-timeline session-history-timeline" data-session-tooltip title="'+sessionAttributeValue(activityTooltip)+'"><span><small>'+adminText('admin.sessions.issued')+'</small><time>'+esc(issuedAt)+'</time></span><span><small>'+adminText('admin.sessions.ended')+'</small><time>'+esc(endedAt)+'</time></span></span></td>';
                  rows+='<td data-label="'+sessionAttributeValue(adminText('admin.sessions.device'))+'"><span class="active-session-cell active-session-device" data-session-tooltip title="'+sessionAttributeValue(deviceInfo)+'"><i class="fa fa-desktop" aria-hidden="true"></i><span>'+esc(deviceInfo)+'</span></span></td>';
                  rows+='<td data-label="'+sessionAttributeValue(adminText('admin.sessions.end_reason'))+'"><span class="active-session-status is-expired" data-session-tooltip title="'+sessionAttributeValue(endReason)+'"><i class="fa fa-history" aria-hidden="true"></i><span>'+esc(endReason)+'</span></span></td></tr>';
               });
               $('#session_history_rows').html(rows||'<tr class="active-session-state-row"><td colspan="4"><strong>'+adminText('admin.sessions.history_empty')+'</strong></td></tr>');initializeSessionHistoryTooltips();
               var m=response.meta||{},p=Number(m.page||1),pages=Number(m.total_pages||1);$('#session_history_pagination').html(Number(m.total||0)?'<button type="button" data-history-page="'+(p-1)+'" '+(p<=1?'disabled':'')+'><i class="fa fa-chevron-left"></i></button><span>'+adminText('admin.sessions.page_of',{page:p,pages:pages})+'</span><button type="button" data-history-page="'+(p+1)+'" '+(p>=pages?'disabled':'')+'><i class="fa fa-chevron-right"></i></button>':'');window.clearTimeout(historyWatchdog);
            },'json').fail(function(){window.clearTimeout(historyWatchdog);$('#session_history_rows').html('<tr class="active-session-state-row is-error"><td colspan="4"><strong>'+adminText('admin.sessions.history_unavailable')+'</strong><small>SH1_REQUEST_FAILED</small></td></tr>');});
         }
...
$(document).on('click', '.dropify-wrapper .dropify-clear', function (e) {
  ...
  oneidConfirm('Remove selected file?', 'The selected file will be cleared from this form.', 'Remove file', function () {
    ...
    $('#edit_existing_app_icon').val('');
      ...
      function modal_user_profile_resetPwd(){
	   ...
	   const canonicalReleaseNotes = <?=json_encode(
    array_map(
      ...
      require dirname(__DIR__) . '/config/content/release_changelog_plain.php'
    ),
  ...
  const releaseNotes = Array.isArray(approvedReleaseNotes)
    && approvedReleaseNotes.length === canonicalReleaseNotes.length
  ...
  renderReleaseNotes();
      ...
      <script
         src="../assetsM/js/user-2fa-temporary-exemption.js?v=20260821-8"
         data-api="../lib/q_func"
         data-csrf="<?=htmlspecialchars(oneid_csrf_token(), ENT_QUOTES, 'UTF-8')?>"
      ...
      #modal_metadata_translations .oneid-metadata-original {
         ...
         border-left: 4px solid #1598ca;
         border-radius: 7px;
         background: #f7fbfd;
      }

      #modal_metadata_translations .oneid-metadata-original-header {
         display: flex;
         align-items: center;
         justify-content: space-between;
         margin-bottom: 10px;
      ...
      #modal_metadata_translations .oneid-metadata-original dl {
         display: grid;
      ...
      #modal_metadata_translations .oneid-metadata-original dt {
         margin-bottom: 3px;
         color: #748396;
         font-size: 10px;
         letter-spacing: .04em;
      ...
      #modal_metadata_translations .oneid-metadata-original dd {
         margin: 0;
         color: #34495e;
         line-height: 1.45;
      }

      #modal_metadata_translations .oneid-metadata-state {
         padding: 4px 9px;
         border-radius: 999px;
         background: #edf1f5;
         color: #667789;
      ...
      #modal_metadata_translations .oneid-metadata-state.is-translated {
         background: #e8f7ee;
         color: #168044;
      }

      #modal_metadata_translations .oneid-metadata-state.is-fallback {
         background: #fff4dd;
         color: #946200;
      }
      ...
      #tab_user .user-search-suggestion{align-items:start;display:grid;gap:3px 10px;grid-template-columns:minmax(140px,160px) minmax(0,1fr) 82px;margin:0;min-height:42px;padding:7px 8px 7px 14px}
      ...
      #tab_user .user-search-suggestion>.user-search-suggestion-status{align-items:center;border-radius:999px;display:inline-flex;font-size:9px;font-weight:800;grid-column:3;height:22px;justify-content:center;margin:0;max-width:82px;min-width:82px;padding:0 7px;text-align:center;text-transform:uppercase;white-space:nowrap;width:82px}
      ...
      @media(max-width:520px){
        #tab_user .user-search-suggestion{gap:2px 8px;grid-template-columns:minmax(0,1fr) 82px;padding:7px 9px}
        #tab_user .user-search-suggestion>strong{grid-column:1;grid-row:1}
        #tab_user .user-search-suggestion>span{grid-column:1;grid-row:2}
        #tab_user .user-search-suggestion>.user-search-suggestion-status{grid-column:2;grid-row:1/3}
      }
      ...
      #tab_active_sessions .active-session-filter.session-history-filter{grid-template-columns:minmax(0,1fr) minmax(0,1fr) minmax(170px,1fr) 120px 42px;grid-template-rows:auto auto}#tab_active_sessions .session-history-filter__query{grid-column:1/-1;grid-row:1}#tab_active_sessions .session-history-filter input.session-history-filter__date{grid-row:2;min-width:0;padding:8px 10px;width:100%}#tab_active_sessions .session-history-filter__reason{grid-column:3;grid-row:2;min-width:0;text-overflow:ellipsis}#tab_active_sessions .session-history-filter__size{grid-column:4;grid-row:2;min-width:0}#tab_active_sessions .session-history-filter__submit{grid-column:5;grid-row:2;width:42px}
      #tab_active_sessions .session-history-card .active-session-card-heading{padding:14px 20px 12px}#tab_active_sessions .session-history-card .active-session-filter{gap:8px;padding:9px 20px}#tab_active_sessions .session-history-table .session-history-col-user{width:27%}#tab_active_sessions .session-history-table .session-history-col-activity{width:28%}#tab_active_sessions .session-history-table .session-history-col-device{width:27%}#tab_active_sessions .session-history-table .session-history-col-reason{width:18%}#tab_active_sessions .session-history-table tbody td{padding:7px 10px;vertical-align:middle}#tab_active_sessions .session-history-table .session-history-timeline{gap:2px;grid-template-columns:1fr}#tab_active_sessions .session-history-table .session-history-timeline>span{align-items:center;display:grid;gap:5px;grid-template-columns:52px minmax(0,1fr);padding-left:6px}#tab_active_sessions .session-history-table .session-history-timeline small{margin:0}#tab_active_sessions .session-history-table [data-session-tooltip]{cursor:help;max-width:100%}#tab_active_sessions .session-history-table .active-session-status span{display:block;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.oneid-session-history-tooltip .tooltip-inner{box-shadow:0 7px 18px rgba(17,35,54,.22);max-width:calc(100vw - 32px);overflow:hidden;padding:7px 11px;text-overflow:ellipsis;white-space:nowrap;width:max-content}
      ...
      @media (max-width: 767px) {
        ...
        #tab_active_sessions .active-session-filter.session-history-filter {
          grid-template-columns: 1fr 1fr;
      ...
      #tab_reports .admin-report-tabs{grid-template-columns:repeat(6,minmax(0,1fr))}
      #tab_reports .admin-report-tabs:before,#tab_reports .admin-report-tabs:after{content:none;display:none}
      #tab_reports .admin-report-tabs > li > a{border:0;border-bottom:3px solid transparent;border-radius:0;margin:0}
      #tab_reports .admin-report-tabs > li > a span{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
      ...
      .sweet-alert.oneid-archive-purge-alert{border-radius:14px;padding:28px 30px 24px;width:620px}.sweet-alert.oneid-archive-purge-alert .sa-icon.sa-warning{height:58px;margin:0 auto 12px;width:58px}.sweet-alert.oneid-archive-purge-alert h2{color:#18334a;font-size:23px;font-weight:700;margin:8px 0 18px}.oneid-archive-purge-panel{text-align:left}.oneid-archive-purge-risk{align-items:flex-start;background:#fff6f3;border:1px solid #f2cbc5;border-radius:10px;display:flex;gap:11px;margin-bottom:14px;padding:12px 14px}.oneid-archive-purge-risk>span{align-items:center;background:#fde3de;border-radius:8px;color:#c84b40;display:flex;flex:0 0 34px;height:34px;justify-content:center}.oneid-archive-purge-risk strong,.oneid-archive-purge-risk small{display:block}.oneid-archive-purge-risk strong{color:#9f332b;font-size:12px;margin-bottom:3px;text-transform:uppercase}.oneid-archive-purge-risk small{color:#7e5551;font-size:11px;line-height:1.45}.oneid-archive-purge-field{background:#f8fafc;border:1px solid #dce7ed;border-radius:10px;margin-top:10px;padding:13px 14px}.oneid-archive-purge-field label,.oneid-archive-purge-field small{display:block}.oneid-archive-purge-field label{color:#294354;font-size:11px;font-weight:800;letter-spacing:.03em;margin:0;text-transform:uppercase}.oneid-archive-purge-field small{color:#738795;font-size:10px;margin-top:3px}.oneid-archive-purge-target{align-items:center;background:#edf7fb;border:1px solid #cfe8f1;border-radius:7px;color:#176d8b;display:flex;gap:8px;margin-top:10px;padding:9px 11px}.oneid-archive-purge-target strong{font-size:12px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.sweet-alert.oneid-archive-purge-alert #archive_purge_confirmation,.sweet-alert.oneid-archive-purge-alert #archive_purge_reason{background:#fff;border:1px solid #c9dae4;border-radius:7px;box-shadow:none;color:#263f50;font-size:12px;margin:9px 0 0;padding:10px 11px}.sweet-alert.oneid-archive-purge-alert #archive_purge_confirmation:focus,.sweet-alert.oneid-archive-purge-alert #archive_purge_reason:focus{border-color:#159dcb;box-shadow:0 0 0 3px rgba(21,157,203,.12)}.sweet-alert.oneid-archive-purge-alert #archive_purge_reason{height:82px;resize:vertical}.sweet-alert.oneid-archive-purge-alert .sa-button-container{border-top:1px solid #e3eaee;margin-top:18px;padding-top:16px}.sweet-alert.oneid-archive-purge-alert button{border-radius:7px;font-size:12px;font-weight:700;margin:0 4px;padding:10px 18px}.sweet-alert.oneid-archive-purge-alert .cancel{background:#eef2f5;color:#344b5a}.sweet-alert.oneid-archive-purge-alert .confirm{box-shadow:0 4px 10px rgba(194,65,55,.18)}@media(max-width:680px){.sweet-alert.oneid-archive-purge-alert{left:4%;margin:0!important;padding:22px 16px;width:92%}}
      .sweet-alert.oneid-archive-purge-alert #archive_purge_confirmation,.sweet-alert.oneid-archive-purge-alert #archive_purge_reason,.sweet-alert.oneid-archive-purge-alert #archive_purge_reason_option{display:block;width:100%}.sweet-alert.oneid-archive-purge-alert #archive_purge_reason_option{background:#fff;border:1px solid #c9dae4;border-radius:7px;color:#263f50;font-size:12px;height:40px;margin-top:10px;padding:0 10px}.sweet-alert.oneid-archive-purge-alert #archive_purge_reason_option:focus{border-color:#159dcb;box-shadow:0 0 0 3px rgba(21,157,203,.12);outline:0}.oneid-archive-purge-custom-reason{display:none;margin-top:12px}.oneid-archive-purge-custom-reason label{font-size:10px}.sweet-alert.oneid-archive-purge-alert .show-input-error~.sa-button-container{margin-top:12px}
      ...
      #tab_synclog .sync-log-table:not(.sync-detail-table) th:nth-child(1) { width: 15%; }
      #tab_synclog .sync-log-table:not(.sync-detail-table) th:nth-child(2) { width: 18%; }
      #tab_synclog .sync-log-table:not(.sync-detail-table) th:nth-child(3) { width: 17%; }
      #tab_synclog .sync-log-table:not(.sync-detail-table) th:nth-child(4) { width: 27%; }
      #tab_synclog .sync-log-table:not(.sync-detail-table) th:nth-child(5) { width: 17%; }
      #tab_synclog .sync-log-table:not(.sync-detail-table) th:nth-child(6) { width: 6%; }

      #tab_synclog .sync-log-table:not(.sync-detail-table) th:nth-child(5),
      #tab_synclog .sync-log-table:not(.sync-detail-table) td:nth-child(5) {
        text-align: left !important;
      }
      ...
      #tab_synclog .sync-log-table:not(.sync-detail-table) .sync-status-badge {
        width: 100%;
        max-width: 150px;
        min-width: 0;
        justify-content: flex-start;
