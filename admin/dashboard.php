                                                               ...
                                                               <div class="tab-pane fade" id="user_2fa_exemption_panel" role="tabpanel" aria-labelledby="user_2fa_exemption_tab">
                                                                  <div class="sso-config-panel">
                                                                     ...
                                                                     <div class="sso-config-body">
                                                                        ...
                                                                        <div class="sso-config-row"><div class="sso-config-copy"><span class="sso-config-index">05</span><div><label for="user_2fa_exemption_control"><?=htmlspecialchars(oneid_translate('admin.configuration.user_2fa_exemption_control'), ENT_QUOTES, 'UTF-8')?></label><p><?=htmlspecialchars(oneid_translate('admin.configuration.user_2fa_exemption_control_help'), ENT_QUOTES, 'UTF-8')?></p></div></div><div class="sso-config-control"><textarea class="form-control user-2fa-exemption-setting" id="user_2fa_exemption_control" maxlength="500" rows="2" disabled></textarea></div></div>
                                                                        <div class="sso-config-row"><div class="sso-config-copy"><span class="sso-config-index">06</span><div><label for="user_2fa_exemption_confirmation"><?=htmlspecialchars(oneid_translate('admin.configuration.user_mfa_confirmation'), ENT_QUOTES, 'UTF-8')?></label><p><strong id="user_2fa_exemption_confirmation_phrase"></strong></p></div></div><div class="sso-config-control"><input class="form-control user-2fa-exemption-setting" id="user_2fa_exemption_confirmation" autocomplete="off" disabled><button type="button" class="btn btn-default btn-sm mt-10 user-2fa-exemption-setting" onclick="fillUser2faExemptionConfirmation();" disabled><i class="fa fa-copy"></i> <?=htmlspecialchars(oneid_translate('admin.configuration.user_mfa_use_confirmation'), ENT_QUOTES, 'UTF-8')?></button></div></div>
